...
export function BranchPicker({
  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        className="flex w-full cursor-pointer items-center justify-between gap-3 rounded-[1.2rem] border border-white/10 bg-white/[0.04] px-3.5 py-3 text-left transition hover:bg-white/[0.06] disabled:cursor-not-allowed disabled:opacity-60"
        type="button"
      ...
      >
        <div className="min-w-0">
          ...
          <div className="mt-2 flex min-w-0 items-center gap-2">
            ...
            {selected?.isDefault ? (
              <span className="rounded-full border border-white/10 bg-white/5 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-sage-300">
                Default
              </span>
            ) : null}
          </div>
